...
headers = {
    ...
    'Ocp-Apim-Subscription-Key': '59e806b454934ce9b5898af806ea64e5'
}
...
def analyze_image(data):
    try:
        ...
        conn.request("POST", "https://shitalgaikwadcv.cognitiveservices.azure.com/vision/v1.0/analyze?%s" % params, data, headers)
